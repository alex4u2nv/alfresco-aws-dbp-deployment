# Customized Alfresco DBP Deployment
This customized version of the DBP is updated to work in an existing VPC, with networking already managed by network team.
It also updates alfresco identity service to use a database service, as opposed to it's own postgresql database.
